...
\title{MAC05921 – Deep Learning –  Relatório Tarefa 3} % Title of the assignment

\author{Giovani Tavares\\ \texttt{giovanitavares@usp.br (10788620)}} % Author name and email address

\date{Universidade de São Paulo --- \today} % University, school and/or department name(s) and a date
...
Este relatório contem a descrição do experimento realizado na \textbf{Tarefa 3}. 
Nessa tarefa buscou-se realizar um \textbf{estudo de ablação} na rede \textbf{U-Net} para a tarefa de segmentação de imagens. 
