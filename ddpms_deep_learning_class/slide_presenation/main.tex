...
%----------------------------------------------------------------------------------------
\title[DDPM]{Denoising Diffusion Probabilistic Models}          % [Versão curta]{Versão completa}
\author[Giovani Tavares]{Giovani Tavares de Andrade}            % [Versão curta]{Nome completo}
